		...
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-7">
					...
					?>
					<div class="row">
						<div class="col-md-6 padRight5 mobile-img">
						...
						<div class="col-md-6 padLeft5 mobile-img">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-7">
					...
					<div class="row top-buffer mobile-img">
						<div class="col-md-6 padRight5 mobile-img">
		...
		<div id="gear-acf" class="container">
			<div class="row">
				...
				<div class="g-col1 col-md-4">
					...
					<div class="g-box"><?php the_field('g-column1-b7'); ?></div>
				</div>
				<div class="g-col2 col-md-4">
					...
					<div class="g-box"><?php the_field('g-column2-b6'); ?></div>
					<div class="g-box"><?php the_field('g-column2-b7'); ?></div>
				</div>
